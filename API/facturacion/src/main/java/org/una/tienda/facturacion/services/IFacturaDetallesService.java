...
public interface IFacturaDetallesService {
    ...
    public Factura_DetallesDTO create(Factura_DetallesDTO factura_DetallesDTO) throws ProductoConDescuentoMayorAlPermitidoException, FacturaConCantidadCeroException, FacturaConPrecioCeroException;
